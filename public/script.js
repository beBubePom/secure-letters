...
(function initCountdown() {
  const QUOTES = [
    ...
    "sắp rồi em ơi, chồng hứa xứng đáng mà",
    "em kiên nhẫn thêm tí nha vợ yêu",
    "chưa tới ngày đâu babi, nhưng sắp lắm rồi",
    "đợi chồng thêm xíu thôi nha em",
    "thư vẫn đang ngủ, chưa tới giờ mở đâu vợ ơi",
    "em cứ chờ nhé, chồng đang giữ điều bất ngờ cho em",
    "chưa đến lúc đâu em ơi, nhưng khi đến sẽ đáng chờ lắm",
    "thêm một chút kiên nhẫn nữa thôi vợ yêu",
    "em đợi được không? chồng hứa sẽ không phụ lòng đâu",
    "chưa tới ngày mở thư đâu nha babi",
    "em cứ từ từ, thư chưa sẵn sàng cho em đọc đâu",
    "đợi thêm chút thôi, phần thưởng đang chờ em mà",
    "thư này còn đang ngủ, chờ chồng đánh thức nhé",
    "vợ yêu ơi, sắp đến ngày rồi mà",
    "em cứ đợi nhé, chồng đang viết từng chữ bằng cả trái tim",
    "chưa đến giờ đâu em, nhưng chồng đang nghĩ đến em đó",
    "thư chưa chín muồi, đợi thêm xíu nha em yêu",
    "em mà đọc sớm thì mất đi sự bất ngờ rồi",
    "vợ của chồng ơi, cứ từ từ thôi nha",
    "chồng biết em nôn nóng lắm, nhưng đợi thêm chút xíu nha",
    "thư đang được giữ kỹ cho đến đúng ngày em ơi",
    "em cứ chờ đi, khoảnh khắc mở thư sẽ rất đáng nhớ",
    "vợ yêu kiên nhẫn thêm xíu nhé, chồng hứa",
    "sắp đến rồi babi, em đừng nôn quá",
    "thư này đang chờ đúng thời điểm để gặp em",
    "em đợi chồng với nhé, không lâu đâu",
    "chưa tới ngày đó đâu em, nhưng chồng đang nhớ em lắm",
    "vợ yêu ơi, thêm chút nữa thôi là gặp nhau rồi",
    "thư đang nằm im chờ đúng ngày, giống em chờ chồng vậy",
    "em cứ từ từ, điều tốt đẹp luôn đáng để đợi mà",
    "chồng biết em muốn đọc lắm, nhưng thêm tí nha vợ",
    "thư chưa đến lúc được mở, em ơi",
    "vợ yêu đợi thêm nhé, chồng đang giữ nhiều điều cho em",
    "chưa phải lúc đâu em, nhưng khi đến chắc chắn đẹp lắm",
    "em cứ chờ đi nha, như chồng luôn chờ nụ cười của em vậy",
    "thư này đặc biệt lắm, nên phải đúng ngày mới mở được",
    "vợ của chồng ơi, kiên nhẫn thêm tí thôi",
    "sắp rồi em yêu, chồng hứa không để em chờ lâu đâu",
    "thư đang ngủ yên, đợi đúng ngày mới thức dậy em ơi",
    "em cứ đợi nhé, thư này được viết bằng cả tấm lòng",
    "chưa tới ngày mở đâu vợ ơi, nhưng chồng đang nghĩ đến em",
    "vợ yêu của chồng, thêm chút kiên nhẫn nha",
    "thư chưa sẵn sàng cho em đâu, đợi thêm xíu nhé",
    "em đợi thêm một chút, chồng hứa xứng đáng mà",
    "chưa đến lúc đâu em ơi, nhưng sắp lắm rồi",
    "vợ cứ thư thả, thư đang chờ đúng thời điểm",
    "em kiên nhẫn nha, điều đẹp đang chờ em phía trước",
    "thư này được giữ cẩn thận cho em, đợi đúng ngày nhé",
    "chồng biết em nóng lòng, nhưng thêm tí nữa nha vợ yêu",
    "vợ ơi, thư đang chờ em đúng ngày thôi",
    "sắp đến rồi em ơi, chồng đang đếm từng ngày với em",
    "em cứ chờ đi, như ánh sáng cuối đường hầm vậy",
    "thư chưa đến giờ thức dậy, em ơi",
    "vợ yêu kiên nhẫn thêm nhé, chồng đang chờ cùng em",
    "chưa phải lúc mở thư đâu em, nhưng chồng đang ở đây",
    "em đợi thêm chút xíu, thư sẽ đến đúng lúc",
    "thư đang được bảo vệ cho đến ngày đặc biệt em ơi",
    "vợ của chồng đợi thêm tí nha, không lâu đâu",
    "chưa tới ngày rồi em ơi, nhưng chồng nhớ em lắm",
    "em cứ từ từ, thư này đặc biệt nên cần đúng thời điểm",
    "vợ yêu ơi, thêm vài ngày nữa thôi là gặp nhau rồi",
    "thư đang chờ em như chồng luôn chờ nụ cười của em",
    "chồng hứa thư này sẽ đáng để em đợi",
    "em cứ kiên nhẫn nha vợ yêu, sắp rồi mà",
    "thư chưa đến lúc được mở ra, đợi đúng ngày em nhé",
    "vợ của chồng ơi, cứ từ từ thôi",
    "chưa đến giờ đâu em, nhưng mỗi ngày chồng đều nghĩ đến em",
    "em đợi thêm nhé, thư được viết từ tận đáy lòng chồng",
    "vợ yêu kiên nhẫn xíu nữa nhé",
    "thư này đang chờ đúng ngày để gặp em đó",
    "chồng biết em muốn đọc, nhưng chưa đến lúc đâu em ơi",
    "em cứ chờ đi, phần thưởng xứng đáng đang chờ em",
    "thư chưa sẵn sàng, nhưng chồng thì lúc nào cũng sẵn sàng yêu em",
    "vợ yêu ơi, đợi chồng thêm chút thôi nha",
    "chưa tới ngày mở thư đâu em, hãy cứ chờ thêm",
    "em kiên nhẫn thêm xíu, chồng đang giữ điều tốt đẹp cho em",
    "thư này cần đúng ngày mới có thể gặp em được",
    "vợ của chồng cứ thư thả, thư đang chờ em mà",
    "chồng hứa khi đến ngày, em sẽ không hối hận vì đã đợi",
    "em cứ đợi nhé, mỗi ngày trôi qua là gần hơn với thư đó",
    "thư đang nằm đây chờ em, nhưng chưa đến lúc đâu",
    "vợ yêu của chồng, thêm chút nữa thôi là đến rồi",
    "chưa phải lúc đâu em ơi, nhưng ngày đó sắp đến rồi",
    "em đợi chồng nhé, như chồng luôn đợi được nhìn thấy em",
    "thư chưa đến giờ thức, em cứ từ từ thôi",
    "vợ kiên nhẫn thêm xíu nhé, chồng đang đếm từng ngày",
    "chưa tới ngày đặc biệt đó đâu em, nhưng sắp lắm rồi",
    "em cứ chờ đi, thư này được viết với rất nhiều tình cảm",
    "thư đang chờ đúng thời điểm để gặp em, em ơi",
    "vợ yêu ơi, đợi thêm chút nữa là gặp nhau rồi",
    "chồng biết em nôn nóng, nhưng điều tốt đẹp đáng để chờ mà",
    "em cứ kiên nhẫn, thư này đặc biệt lắm",
    "thư chưa được mở, đang đợi đúng ngày của nó em ơi",
    "vợ của chồng ơi, sắp đến rồi nha",
    "chưa đến lúc đâu em, nhưng chồng đang nghĩ đến em mỗi ngày",
    "em đợi thêm nhé, thư này xứng đáng với sự chờ đợi của em",
    "vợ yêu kiên nhẫn nha, không lâu nữa đâu",
    "thư đang chờ em như ánh trăng chờ màn đêm",
    "chồng hứa ngày đó sẽ đến, em cứ chờ nhé",
    "em cứ từ từ thôi vợ yêu, điều đẹp đang ở phía trước",
    "thư chưa sẵn sàng gặp em, đợi đúng ngày nhé",
    "vợ ơi, thêm chút kiên nhẫn nữa thôi là đến rồi",
    "chưa tới ngày đó đâu em, nhưng chồng luôn ở đây",
    "em đợi thêm xíu, thư đang chờ đúng khoảnh khắc để gặp em",
    "vợ yêu của chồng, sắp rồi em ơi",
    "thư này không đi đâu hết, nó đang chờ em đúng ngày thôi",
    "em kiên nhẫn thêm tí nha, chồng đang đếm ngày cùng em",
    "chưa đến lúc mở thư đâu vợ yêu ơi",
    "em cứ chờ nhé, như chồng luôn chờ được ở bên em vậy",
    "thư đặc biệt này cần đúng thời điểm để gặp em",
    "vợ yêu kiên nhẫn thêm nhé, chồng không bao giờ để em thất vọng đâu",
    "sắp đến ngày rồi em ơi, đợi chồng thêm chút thôi",
    "thư chưa đến giờ thức dậy, em cứ từ từ thôi vợ yêu",
    "chồng biết em đang chờ, và chồng cũng đang chờ cùng em",
    "em đợi thêm nhé, thư này mang theo rất nhiều tình cảm của chồng",
    "vợ của chồng ơi, kiên nhẫn thêm xíu thôi",
    "chưa phải lúc đâu em, nhưng mỗi ngày trôi qua là gần hơn",
    "em cứ từ từ, thư sẽ đến đúng lúc như chồng luôn ở đây với em",
    "thư đang được giữ cho em, đợi đúng ngày nha vợ yêu",
    "vợ yêu ơi, thêm chút nữa là đọc được rồi",
    "chồng đang đếm ngày cùng em, sắp rồi vợ ơi",
    "em kiên nhẫn nha, thư này được viết từ những khoảnh khắc đặc biệt nhất",
    "thư chưa tới ngày, nhưng tình cảm của chồng thì luôn ở đây em ơi",
    "vợ của chồng cứ chờ thêm tí thôi, không lâu đâu",
    "chưa đến lúc mở thư đâu em, đợi chồng với nhé",
    "em cứ đợi đi, phần thưởng xứng đáng đang chờ ở cuối đường",
    "thư này cần đúng ngày để trao cho em, em ơi",
    "vợ yêu kiên nhẫn nhé, sắp rồi mà",
    "chồng đang đếm từng ngày đến khi em được đọc thư này",
    "em đợi thêm chút xíu nha, thư đang chờ em mà",
    "thư chưa đến lúc gặp em, nhưng chồng thì lúc nào cũng nhớ em",
    "vợ ơi, sắp đến rồi, kiên nhẫn thêm một chút nữa nhé",
    "em cứ từ từ thôi, điều tốt đẹp nhất đang chờ em ở phía trước",
    "thư đang ngủ yên chờ đúng ngày, em cứ đợi nhé",
    "vợ yêu của chồng ơi, không lâu nữa đâu em",
    "chưa tới ngày mở thư đâu em, nhưng chồng luôn yêu em",
    "em đợi chồng thêm nhé, như chồng đợi mỗi ngày được thấy em cười",
    "thư này đặc biệt vì được viết riêng cho em, đợi đúng ngày nhé",
    "vợ yêu kiên nhẫn thêm xíu nữa nhé, sắp rồi em ơi",
    "chưa phải lúc đâu vợ ơi, nhưng ngày đó đang đến gần",
    "em cứ chờ đi, mỗi ngày đợi là một ngày chồng nhớ em thêm",
    "thư chưa sẵn sàng gặp em hôm nay, đợi đúng ngày em nhé",
    "vợ của chồng ơi, thêm tí kiên nhẫn thôi là được đọc rồi",
    "chồng biết em đang đợi, và điều đó khiến chồng trân trọng em hơn",
    "em đợi thêm nhé, thư này được viết với rất nhiều tình yêu thương",
    "vợ yêu ơi, sắp đến ngày rồi, đợi chồng thêm xíu thôi",
    "thư đang chờ đúng thời điểm, như chồng chờ mãi được ở bên em",
    "chưa tới lúc đâu em, nhưng mỗi ngày chồng đều nghĩ về em",
    "em cứ kiên nhẫn nha vợ yêu, điều đẹp đẽ đang chờ em",
    "thư này cần đúng ngày để trọn vẹn nhất khi gặp em",
    "vợ ơi, đợi thêm chút nữa thôi là gặp nhau rồi",
    "chồng đang giữ thư này cẩn thận cho em, đợi đúng ngày nhé",
    "em đợi được không? chồng đang cố gắng mỗi ngày vì em đó",
    "thư chưa đến lúc, nhưng tình cảm trong đó thì luôn đầy ắp",
    "vợ yêu của chồng, kiên nhẫn thêm xíu thôi nha",
    "chưa đến ngày đặc biệt đó đâu em, nhưng sắp lắm rồi",
    "em cứ từ từ, thư đang chờ em như chồng luôn chờ được nhìn thấy em",
    "thư này được viết từ trái tim, cần đúng ngày mới trao cho em được",
    "vợ yêu kiên nhẫn nha, chồng hứa sẽ không để em thất vọng",
    "sắp rồi em ơi, đợi chồng thêm chút thôi vợ yêu",
    "thư chưa đến giờ gặp em hôm nay, nhưng ngày đó đang đến gần",
    "chồng biết em mong lắm, chồng cũng đang mong cùng em",
    "em đợi thêm xíu nhé, thư này có nhiều điều chồng muốn nói với em",
    "vợ của chồng ơi, không lâu nữa đâu, cứ từ từ thôi",
    "chưa phải lúc mở thư em ơi, nhưng chồng luôn ở đây với em",
    "em cứ chờ đi, như chồng luôn chờ những khoảnh khắc bên em",
    "thư đang được bảo vệ cẩn thận cho đến đúng ngày, em ơi",
    "vợ yêu ơi, thêm mấy ngày nữa thôi là được đọc rồi",
    "chồng đang đếm ngày cùng em, sắp tới rồi vợ yêu",
    "em kiên nhẫn thêm nhé, điều đặc biệt đang chờ em ở phía trước",
    "thư chưa tới ngày thức dậy, nhưng nó đang chờ em đó",
    "vợ của chồng cứ đợi thêm xíu thôi, sắp rồi mà",
  ];

...
// ══════════════════════════════════════════════════════════════════════════════
const BOX_COLORS = [
  { border:"rgba(200,140,255,0.75)", hover:"rgba(220,170,255,1)", bg:"rgba(180,120,255,0.12)", glow:"rgba(200,140,255,0.45)" },
  { border:"rgba(120,195,255,0.75)", hover:"rgba(160,220,255,1)", bg:"rgba(110,190,255,0.12)", glow:"rgba(120,195,255,0.45)" },
  { border:"rgba(255,150,170,0.75)", hover:"rgba(255,185,200,1)", bg:"rgba(255,130,150,0.10)", glow:"rgba(255,150,170,0.45)" },
  { border:"rgba(80,230,185,0.75)",  hover:"rgba(120,255,210,1)", bg:"rgba(80,225,180,0.10)",  glow:"rgba(80,230,185,0.45)"  },
  { border:"rgba(255,210,100,0.75)", hover:"rgba(255,230,140,1)", bg:"rgba(255,205,90,0.10)",  glow:"rgba(255,210,100,0.45)" },
  { border:"rgba(160,210,255,0.75)", hover:"rgba(195,230,255,1)", bg:"rgba(150,205,255,0.12)", glow:"rgba(160,210,255,0.45)" },
  { border:"rgba(230,130,255,0.75)", hover:"rgba(248,165,255,1)", bg:"rgba(225,120,255,0.10)", glow:"rgba(230,130,255,0.45)" },
  { border:"rgba(100,248,210,0.75)", hover:"rgba(135,255,225,1)", bg:"rgba(90,242,205,0.10)",  glow:"rgba(100,248,210,0.45)" },
];
